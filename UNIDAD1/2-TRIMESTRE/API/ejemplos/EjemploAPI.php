...
$html = file_get_contents("http://api.openweathermap.org/data/2.5/weather?q=Valencia,es&appid=96edde9f7c64ae00b99322b16b678542");
echo '<pre>';
print_r ($html);
echo '</pre>';
...
echo "<b>Velocidad del Viento</b> : ".$vel_viento." <br>";
